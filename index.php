...
$f3->route('GET /opml', 'controllers\Opml\ImportPage->show'); // html
$f3->route('POST /opml', 'controllers\Opml\Import->add'); // json
$f3->route('GET /opmlexport', 'controllers\Export->export'); // xml
